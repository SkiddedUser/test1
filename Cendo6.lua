...
weld.Part1 = handle
weld.C0 = CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(90), 0, 0) -- Ajustado para que la espada apunte hacia adelante
...
local function shakeObject(object)
    ...
    while true do
        local offsetX = math.random(-1, 1) * 1
        local offsetY = math.random(-1, 1) * 1
...
-- Iniciar la animación de los ojos
animateBothEyes()
